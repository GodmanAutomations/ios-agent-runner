...
- REST API
  ...
  - [Figma files](https://developers.figma.com/docs/rest-api/files/)

  - [Comments](https://developers.figma.com/docs/rest-api/comments-types/)

  - [Users](https://developers.figma.com/docs/rest-api/users-types/)

  - [Version history](https://developers.figma.com/docs/rest-api/version-history-types/)

  - [Projects](https://developers.figma.com/docs/rest-api/projects-types/)

  - [Components](https://developers.figma.com/docs/rest-api/component-types/)
  ...
  - [Discovery](https://developers.figma.com/docs/rest-api/discovery/)

  - [Payments](https://developers.figma.com/docs/rest-api/payments/)
  ...
  - [SCIM API Reference](https://developers.figma.com/docs/rest-api/scim/)
